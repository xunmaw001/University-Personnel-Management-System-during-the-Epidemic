...
public class XueshengdakaView extends XueshengdakaEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 打卡状态的值
		*/
		private String xueshengdakaZhuangtaiValue;
	...
	public XueshengdakaView(XueshengdakaEntity xueshengdakaEntity) {
		try {
			...
			* 获取： 打卡状态的值
			*/
			public String getXueshengdakaZhuangtaiValue() {
				return xueshengdakaZhuangtaiValue;
			}
			/**
			* 设置： 打卡状态的值
			*/
			public void setXueshengdakaZhuangtaiValue(String xueshengdakaZhuangtaiValue) {
				this.xueshengdakaZhuangtaiValue = xueshengdakaZhuangtaiValue;
			}
