...
public class LaoshijujiaView extends LaoshijujiaEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 居家状态的值
		*/
		private String laoshijujiaZhuangtaiValue;
	...
	public LaoshijujiaView(LaoshijujiaEntity laoshijujiaEntity) {
		try {
			...
			* 获取： 居家状态的值
			*/
			public String getLaoshijujiaZhuangtaiValue() {
				return laoshijujiaZhuangtaiValue;
			}
			/**
			* 设置： 居家状态的值
			*/
			public void setLaoshijujiaZhuangtaiValue(String laoshijujiaZhuangtaiValue) {
				this.laoshijujiaZhuangtaiValue = laoshijujiaZhuangtaiValue;
			}
