...
public class LaoshifanxiaoshenqingView extends LaoshifanxiaoshenqingEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String laoshifanxiaoshenqingYesnoValue;
	...
	public LaoshifanxiaoshenqingView() {

	}

	public LaoshifanxiaoshenqingView(LaoshifanxiaoshenqingEntity laoshifanxiaoshenqingEntity) {
		try {
			BeanUtils.copyProperties(this, laoshifanxiaoshenqingEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getLaoshifanxiaoshenqingYesnoValue() {
				return laoshifanxiaoshenqingYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setLaoshifanxiaoshenqingYesnoValue(String laoshifanxiaoshenqingYesnoValue) {
				this.laoshifanxiaoshenqingYesnoValue = laoshifanxiaoshenqingYesnoValue;
			}
