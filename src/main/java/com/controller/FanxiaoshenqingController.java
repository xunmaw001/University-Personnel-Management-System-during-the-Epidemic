    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(fanxiaoshenqing !=null){
            ...
            BeanUtils.copyProperties( fanxiaoshenqing , view );//把实体数据重构到view中
                ...
                //级联表
                XueshengEntity xuesheng = xueshengService.selectById(fanxiaoshenqing.getXueshengId());
                if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody FanxiaoshenqingEntity fanxiaoshenqing, HttpServletRequest request){
        ...
        if(false)
            ...
            fanxiaoshenqing.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<FanxiaoshenqingEntity> queryWrapper = new EntityWrapper<FanxiaoshenqingEntity>()
            .eq("xuesheng_id", fanxiaoshenqing.getXueshengId())
        ...
        if(fanxiaoshenqingEntity==null){
            ...
            XueshengEntity xueshengEntity = xueshengService.selectById(fanxiaoshenqing.getXueshengId());
            DiquEntity diquEntity = diquService.selectById(xueshengEntity.getDiquId());
            if(diquEntity.getDiquZhuangtaiTypes() != 1){
                fanxiaoshenqing.setFanxiaoshenqingYesnoTypes(3);
                fanxiaoshenqing.setFanxiaoshenqingYesnoText("当前学生在中高风险地区 不同意返校申请");
...
//                            fanxiaoshenqingEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
