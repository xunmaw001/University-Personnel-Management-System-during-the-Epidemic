    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xuesheng !=null){
            ...
            BeanUtils.copyProperties( xuesheng , view );//把实体数据重构到view中
                ...
                //级联表
                DiquEntity diqu = diquService.selectById(xuesheng.getDiquId());
                if(diqu != null){
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            xueshengEntity.setDiquId(Integer.valueOf(data.get(1)));   //地区 要改的
                            ...
                            xueshengEntity.setXueshengzaixiaoTypes(Integer.valueOf(data.get(6)));   //是否在校 要改的
                            xueshengEntity.setXueshengEmail(data.get(7));                    //电子邮箱 要改的
    ...
    public R getCurrXuesheng(HttpServletRequest request){
        ...
        if(xuesheng !=null){
            ...
            //级联表
                            DiquEntity diqu = diquService.selectById(xuesheng.getDiquId());
            if(diqu != null){
                BeanUtils.copyProperties( diqu , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                view.setDiquId(diqu.getId());
            }
            //修改对应字典表字段
            dictionaryService.dictionaryConvert(view, request);
