    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(laoshi !=null){
            ...
            BeanUtils.copyProperties( laoshi , view );//把实体数据重构到view中
                ...
                //级联表
                DiquEntity diqu = diquService.selectById(laoshi.getDiquId());
                if(diqu != null){
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            laoshiEntity.setDiquId(Integer.valueOf(data.get(1)));   //老师 要改的
                            ...
                            laoshiEntity.setLaoshizaixiaoTypes(Integer.valueOf(data.get(6)));   //是否在校 要改的
                            laoshiEntity.setLaoshiEmail(data.get(7));                    //电子邮箱 要改的
