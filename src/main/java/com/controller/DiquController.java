    ...
    */
    ...
    public R save(@RequestBody DiquEntity diqu, HttpServletRequest request){
        ...
        Wrapper<DiquEntity> queryWrapper = new EntityWrapper<DiquEntity>()
            ...
            .eq("diqu_zhuangtai_types", diqu.getDiquZhuangtaiTypes())
            ;
...
//                            diquEntity.setDiquAddress(data.get(0));                    //地址位置 要改的
//                            diquEntity.setDiquTypes(Integer.valueOf(data.get(0)));   //地区类型 要改的
//                            diquEntity.setDiquZhuangtaiTypes(Integer.valueOf(data.get(0)));   //风险等级 要改的
