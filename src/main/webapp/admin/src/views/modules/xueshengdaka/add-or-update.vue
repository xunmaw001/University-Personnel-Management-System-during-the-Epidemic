    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="打卡状态" prop="xueshengdakaZhuangtaiTypes">
                        <el-select v-model="ruleForm.xueshengdakaZhuangtaiTypes" :disabled="ro.xueshengdakaZhuangtaiTypes" placeholder="请选择打卡状态">
                            <el-option
                                v-for="(item,index) in xueshengdakaZhuangtaiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="打卡状态" prop="xueshengdakaZhuangtaiValue">
                        <el-input v-model="ruleForm.xueshengdakaZhuangtaiValue"
                            placeholder="打卡状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="打卡备注" prop="xueshengdakaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xueshengdakaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xueshengdakaContent" label="打卡备注" prop="xueshengdakaContent">
                            <span v-html="ruleForm.xueshengdakaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    xueshengdakaZhuangtaiTypes: false,
                    insertTime: false,
                    xueshengdakaContent: false,
                },
                ruleForm: {
                    xueshengId: '',
                    xueshengdakaZhuangtaiTypes: '',
                    insertTime: '',
                    xueshengdakaContent: '',
                },
                xueshengdakaZhuangtaiTypesOptions : [],
                xueshengOptions : [],
                rules: {
                   xueshengId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueshengdaka_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengdakaZhuangtaiTypesOptions = data.data.list;
                    }
                });
