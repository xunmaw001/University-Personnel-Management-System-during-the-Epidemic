    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="打卡状态" prop="laoshidakaZhuangtaiTypes">
                        <el-select v-model="ruleForm.laoshidakaZhuangtaiTypes" :disabled="ro.laoshidakaZhuangtaiTypes" placeholder="请选择打卡状态">
                            <el-option
                                v-for="(item,index) in laoshidakaZhuangtaiTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="打卡状态" prop="laoshidakaZhuangtaiValue">
                        <el-input v-model="ruleForm.laoshidakaZhuangtaiValue"
                            placeholder="打卡状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="打卡备注" prop="laoshidakaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.laoshidakaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.laoshidakaContent" label="打卡备注" prop="laoshidakaContent">
                            <span v-html="ruleForm.laoshidakaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    laoshiId: false,
                    laoshidakaZhuangtaiTypes: false,
                    insertTime: false,
                    laoshidakaContent: false,
                },
                ruleForm: {
                    laoshiId: '',
                    laoshidakaZhuangtaiTypes: '',
                    insertTime: '',
                    laoshidakaContent: '',
                },
                laoshidakaZhuangtaiTypesOptions : [],
                laoshiOptions : [],
                rules: {
                   laoshiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=laoshidaka_zhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.laoshidakaZhuangtaiTypesOptions = data.data.list;
                    }
                });
