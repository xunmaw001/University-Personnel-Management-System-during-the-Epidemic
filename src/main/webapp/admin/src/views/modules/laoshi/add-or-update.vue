        ...
        <el-form
            ...
            <input id="diquId" name="diquId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否在校" prop="laoshizaixiaoTypes">
                        <el-select v-model="ruleForm.laoshizaixiaoTypes" :disabled="ro.laoshizaixiaoTypes" placeholder="请选择是否在校">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否在校" prop="laoshizaixiaoValue">
                        <el-input v-model="ruleForm.laoshizaixiaoValue"
