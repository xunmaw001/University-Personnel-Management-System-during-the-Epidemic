    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='diqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="地区类型" prop="diquValue">
                        <el-input v-model="diquForm.diquValue"
                                  placeholder="地区类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="diquId" name="diquId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否在校" prop="xueshengzaixiaoTypes">
                        <el-select v-model="ruleForm.xueshengzaixiaoTypes" :disabled="ro.xueshengzaixiaoTypes" placeholder="请选择是否在校">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否在校" prop="xueshengzaixiaoValue">
                        <el-input v-model="ruleForm.xueshengzaixiaoValue"
                            placeholder="是否在校" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
