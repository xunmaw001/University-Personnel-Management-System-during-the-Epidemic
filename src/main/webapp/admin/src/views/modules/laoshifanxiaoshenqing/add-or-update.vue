    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="申请编号" prop="laoshifanxiaoshenqingUuidNumber">
                       <el-input v-model="ruleForm.laoshifanxiaoshenqingUuidNumber"
                                 placeholder="申请编号" clearable  :readonly="ro.laoshifanxiaoshenqingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="申请编号" prop="laoshifanxiaoshenqingUuidNumber">
                           <el-input v-model="ruleForm.laoshifanxiaoshenqingUuidNumber"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="申请返校日期" prop="laoshifanxiaoshenqingTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.laoshifanxiaoshenqingTime"
                                type="date"
                                placeholder="申请返校日期"
                                :disabled="ro.laoshifanxiaoshenqingTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.laoshifanxiaoshenqingTime" label="申请返校日期" prop="laoshifanxiaoshenqingTime">
                            <span v-html="ruleForm.laoshifanxiaoshenqingTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="申请理由" prop="laoshifanxiaoshenqingContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.laoshifanxiaoshenqingContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.laoshifanxiaoshenqingContent" label="申请理由" prop="laoshifanxiaoshenqingContent">
                            <span v-html="ruleForm.laoshifanxiaoshenqingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.laoshifanxiaoshenqingYesnoTypes" label="审核状态" prop="laoshifanxiaoshenqingYesnoTypes">
                        <el-input v-model="ruleForm.laoshifanxiaoshenqingYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.laoshifanxiaoshenqingYesnoText" label="审核意见" prop="laoshifanxiaoshenqingYesnoText">
                        <span v-html="ruleForm.laoshifanxiaoshenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    laoshiId: false,
                    laoshifanxiaoshenqingUuidNumber: false,
                    insertTime: false,
                    laoshifanxiaoshenqingTime: false,
                    jiankangmaPhoto: false,
                    xingchengmaPhoto: false,
                    hesuanbaogaoPhoto: false,
                    laoshifanxiaoshenqingContent: false,
                    laoshifanxiaoshenqingYesnoTypes: false,
                    laoshifanxiaoshenqingYesnoText: false,
                    updateTime: false,
                },
                ruleForm: {
                    laoshiId: '',
                    laoshifanxiaoshenqingUuidNumber: new Date().getTime(),
                    insertTime: '',
                    laoshifanxiaoshenqingTime: '',
                    jiankangmaPhoto: '',
                    xingchengmaPhoto: '',
                    hesuanbaogaoPhoto: '',
                    laoshifanxiaoshenqingContent: '',
                    laoshifanxiaoshenqingYesnoTypes: '',
                    laoshifanxiaoshenqingYesnoText: '',
                    updateTime: '',
                },
                laoshifanxiaoshenqingYesnoTypesOptions : [],
                laoshiOptions : [],
                rules: {
                   laoshiId: [
                   ...
                   laoshifanxiaoshenqingUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=laoshifanxiaoshenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.laoshifanxiaoshenqingYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `laoshifanxiaoshenqing/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`laoshifanxiaoshenqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.laoshifanxiaoshenqingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
